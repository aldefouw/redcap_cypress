describe('Configuration Check', () => {
    ...
    describe('Control Center', () => {
    	...
    	describe('Control Center Home', () => {
    		it('should have Notifications & Reporting', () => { cy.contains_cc_link('Notifications & Reporting') })
    	...
    	describe('Dashboard', () => {
			...
			it('should have Activity Graphs', () => { cy.contains_cc_link('Activity Graphs') })
    	...
    	describe('Users', () => {
			...
			it('should have Add Users (Table-based Only)', () => { cy.contains_cc_link('Add Users (Table-based Only)') })
			...
			it('should have Administrators & Acct Managers', () => { cy.contains_cc_link('Administrators & Acct Managers') })
    	})
    	...
    	describe('System Configuration', () => {
			...
			it('should have Home Page Settings', () => { cy.contains_cc_link('Home Page Settings') })
