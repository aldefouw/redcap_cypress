...
=======
  Background:
    ...
    And I visit the "My Projects" page
    And I click on the project labeled "23_Logging_v1115"
  ...
  Scenario: Add new record
    ...
    Then I click on the button labeled "Save & Stay"
    And I rename Name with "Testing"
    Then I click on the button labeled "Save & Exit"
  ...
  Scenario: Add new record
    ...
    And I fill in Email with "test2@test.com"
    Then I click on the button labeled "Save & Exit"
