Feature: B.2.10.100 Data Access Groups-DAGs User Interface: The system shall allow for the creation of DAGs and the deletion of DAGs if no users or records are assigned to it.
  ...
  Scenario: B.2.10.100.100 Create, Edit & Delete DAGs
    ...
    ##ACTION: Create DAG
    When I enter "TestGroup3" into the "Group name" input field
    And I click on the button labeled "Add Group"
    ##VERIFY
    Then I should see "TestGroup3"

    ##ACTION: Edit DAG
    When I click on the button labeled "TestGroup3"
    And I enter "RenameGroup3" into "Group name" the input field
    ##VERIFY
    Then I should see "RenameGroup3"

    ##ACTION: Delete DAG
    When I click delete group for the DAG "RenameGroup3" and I accept the confirmation box
    ##VERIFY
