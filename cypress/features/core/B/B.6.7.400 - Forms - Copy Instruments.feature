...
Form Creation: The system shall support the ability to copy data collection instruments and add a suffix to each variable name in the new instrument.
  ...
  I want to see that project Designer is functioning as expected
    ...
    ##ACTION
    When I select "Copy" from the dropdown labeled "Choose action" for the instrument labeled "Text Validation"
    ...
    ##VERIFY
    When I click on the instrument labeled "Text Validation 2"
    ...
    | test_user1 | Manage/Design | Copy data collection instrument |
