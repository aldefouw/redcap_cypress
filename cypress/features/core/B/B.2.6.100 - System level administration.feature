...
##VERIFY_LOG: Verify Update user rights
    ...
    Then I see “Add Test_User1” in the logging table
...
##VERIFY: Verify User with Basic custom rights
    ...
    And I should NOT see "Project Setup"
    And I should NOT see "Designer"
    And I should NOT see "Dictionary"
    And I should see a link labeled "Codebook"
    And I should NOT see "Survey Distribution Tools"
    ...
    And I should NOT see "Project Dashboards"
    And I should NOT see "Alerts & Notifications"
    And I should NOT see "Multi-Language Management"
    And I should NOT see "Calendar"
    And I should NOT see "Data Import Tool"
    And I should NOT see "Logging and Email Logging"
    And I should NOT see "Field Comment Log"
    And I should NOT see "File Repository"
    And I should NOT see "Data Comparison Tool"
    And I should NOT see "User Rights and DAGs"
    And I should NOT see "Customize & Manage Locking/E-signatures"
    And I should NOT see "Data Quality"
    And I should NOT see "API and API Playground"
    And I should NOT see "REDCap Mobile App"
    And I logout
...
##VERIFY: Verify User access to project
    ...
    Then I should see "Logged in as"
    And I click on the link labeled "My Projects"
    Then I should NOT see "B.2.6.100.100"
...
##VERIFY: Verify User access to project
    ...
    Given I am "Test_User1" user who logs into REDCap
    When I click on the link labeled "My Projects"
...
##ACTION: Remove User from project
    ...
    When I click on a button labeled "Remove User" and accept the confirmation window
