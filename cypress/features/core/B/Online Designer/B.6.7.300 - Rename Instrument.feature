Feature: Form Creation: The system shall support the ability to rename data collection instruments.
...
When I select the dropdown option labeled "Rename" from the dropdown labeled "Choose action" for the instrument labeled "Text Validation Rename"
