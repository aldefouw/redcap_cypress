...
When I click the link labeled "Show Completed Projects"
Then I should see "B.6.13.200.100"

When I click on the link labeled "B.6.13.200.100"
And I click the button labeled "Restore Project" in the dialog box
Then I should see "PROJECT RESTORED!" in the dialog box

When I click the link labeled "Close" in the dialog box
