Feature: A.6.4.500 Manage project creation, deletion, and settings
  ...
  "When I click on the link labeled "My Projects"
    And I click on the link labeled "A.6.4.500.100"
    And I click on the link labeled "Project Setup"
    Then I should see the button labeled "Modify" for Repeating instruments and events

    When I click on the button labeled "Modify" for Repeating instruments and events
    ...
    And I enter "MyName" into the field labeled "Name"
    And I click on the button labeled "Save & Add New Instance"
    And I enter "MyOtherName" into the field labeled "Name"
    And I click on the button labeled "Save & Exit Form"
    And I click on the bubble to select a record for the "Survey" longitudinal instrument on event "Event Three"
    ...
    And I click the bubble for the "Survey" longitudinal instrument on event "Event Three" instance "#3"
    And I enter "My repeat event name" into the field labeled "Name"
