Feature: A.2.3.400 Assign administrators and account managers
  ...
  Scenario: A.2.3.400.100 Give and remove user maximum user privileges
    ...
    And I enable the Administrator Privilege "Access to all projects and data" for the administrator "Test_User1"
    ...
    And I enable the Administrator Privilege "Install, upgrade, and configure" for the administrator "Test_User1"
