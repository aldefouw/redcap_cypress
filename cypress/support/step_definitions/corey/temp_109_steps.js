...
Given('I click on the {ordinal}{clickable} nearest the text {string}', (n, type, text) => {
...
// Given(/^I click on the(?: (first|second|third|fourth|fifth|sixth|seventh|eighth|last))? link nearest the text "(.*)"/, (n, text) => {
//     n = ordinal_to_int(n)
...
// Given(/^I click on the(?: (first|second|third|fourth|fifth|sixth|seventh|eighth|last))? button nearest the text "(.*)"/, (n, text) => {
//     n = ordinal_to_int(n)
...
// Given(/^I click on the(?: (first|second|third|fourth|fifth|sixth|seventh|eighth|last))? checkbox nearest the text "(.*)"/, (n, text) => {
//     n = ordinal_to_int(n)
